...
export default {
  ...
  children: [
    { path: 'visualizationSuccess/visualizationSuccess', name: '可视化成功', component: _import('demo/plugins/visualizationsuccess/VisualizationSuccess.vue'), meta: { ...meta, title: '可视化成功' } },
    { path: 'indexingSuccess/indexingSuccess', name: '索引实验成功', component: _import('demo/plugins/indexingsuccess/IndexingSuccess'), meta: { ...meta, title: '索引实验成功' } },
    { path: 'chromosomeSuccess/chromosomeSuccess', name: '数据提取成功', component: _import('demo/plugins/chromosomesuccess/ChromosomeSuccess.vue'), meta: { ...meta, title: '数据提取成功' } },
    { path: 'benchmarkSuccess/benchmarkSuccess', name: '对照实验成功', component: _import('demo/plugins/benchmarksuccess/BenchMarkSuccess.vue'), meta: { ...meta, title: '实验成功' } },
