...
export default {
  ...
  children: [
    ...
    // { path: 'admin/admin', name: 'admin', component: _import('demo/components/admin/admin.vue'), meta: { ...meta, title: '管理员' } },
    // { path: 'user/user', name: 'user', component: _import('demo/components/user/user.vue'), meta: { ...meta, title: '用户' } },
    // { path: 'flight/flight', name: 'flight', component: _import('demo/components/flight/flight.vue'), meta: { ...meta, title: '航班' } },
    // { path: 'ticket/ticket', name: 'ticket', component: _import('demo/components/ticket/ticket.vue'), meta: { ...meta, title: '机票' } },
    { path: 'visualization/visualization', name: 'visualization', component: _import('demo/components/visualization/Visualization.vue'), meta: { ...meta, title: 'DNA可视化' } },
    { path: 'createData/createData', name: 'createData', component: _import('demo/components/createdata/CreateData.vue'), meta: { ...meta, title: '模拟数据' } },
    { path: 'benchmark/benchmark', name: 'benchmark', component: _import('demo/components/benchmark/BenchMark.vue'), meta: { ...meta, title: '实验' } },
    { path: 'chromosome/chromosome', name: 'chromosome', component: _import('demo/components/chromosome/Chromosome.vue'), meta: { ...meta, title: '数据提取' } },
    { path: 'faFile/faFile', name: 'faFile', component: _import('demo/components/fafile/FaFile.vue'), meta: { ...meta, title: 'DNA数据' } },
    { path: 'indexingAlgorithm/indexingAlgorithm', name: 'indexingAlgorithm', component: _import('demo/components/indexingalgorithm/IndexingAlgorithm.vue'), meta: { ...meta, title: '索引实验' } }
    // { path: 'orders/orders', name: 'orders', component: _import('demo/components/orders/orders.vue'), meta: { ...meta, title: '订单' } },
    // { path: 'notice/notice', name: 'notice', component: _import('demo/components/notice/notice.vue'), meta: { ...meta, title: '通知' } }
