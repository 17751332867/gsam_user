...
export default {
  ...
  children: [
    { path: 'pangenomeFile/pangenomeFile', name: 'pangenomeFile',component: _import('demo/playground/pangenomefile/PangenomeFile.vue'),meta: {...meta,title: '我的仿真数据'}},
    { path: 'myVisualization/myVisualization', name: 'myVisualization', component: _import('demo/playground/myvisualization/MyVisualization.vue'), meta: { ...meta, title: '我的可视化' } },
    { path: 'myIndexing/myIndexing', name: 'myIndexing', component: _import('demo/playground/myindexing/MyIndexing'), meta: { ...meta, title: '我的索引实验' } },
    { path: 'myChromosome/myChromosome', name: 'myChromosome', component: _import('demo/playground/mychromosome/MyChromosome.vue'), meta: { ...meta, title: '我的数据提取' } },
    { path: 'benchMarkDetails/benchMarkDetails', name: 'benchMarkDetails', component: _import('demo/playground/benchmarkdetails/BenchMarkDetails'), meta: { ...meta, title: '实验详细信息' } },
    { path: 'myBenchMark/myBenchMark', name: 'myBenchMark', component: _import('demo/playground/mybenchmark/MyBenchMark.vue'), meta: { ...meta, title: '我的对照实验' } }
