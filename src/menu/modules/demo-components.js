export default {
  ...
  children: [
    {
      path: '/demo/components/benchmark/benchmark',
      title: '实验模块',
      icon: 'diamond'
    }, {
      path: '/demo/components/chromosome/chromosome',
      title: '数据提取',
      icon: 'window-restore'
    }, {
      path: '/demo/components/createData/createData',
      title: '仿真数据',
      icon: 'arrows-alt'
    }, {
      path: '/demo/components/faFile/faFile',
      title: 'DNA文件',
      icon: 'flask'
    }, {
      path: '/demo/components/indexingAlgorithm/indexingAlgorithm',
      title: '索引实验',
      icon: 'history'
    }, {
      path: '/demo/components/visualization/visualization',
      title: 'DNA可视化',
      icon: 'eye'
    }
