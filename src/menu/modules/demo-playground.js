export default {
  ...
  icon: 'flask',
  children: [
    { path: '/demo/playground/pangenomeFile/pangenomeFile',title: '我的仿真数据',icon: 'file'},
    { path: '/demo/playground/myIndexing/myIndexing', title: '我的索引实验', icon: 'arrows-alt' },
    { path: '/demo/playground/myChromosome/myChromosome', title: '我的数据提取', icon: 'globe' },
    { path: '/demo/playground/myBenchMark/myBenchMark', title: '我的对照实验', icon: 'info-circle' },
    { path: '/demo/playground/myVisualization/myVisualization', title: '我的可视化', icon: 'info-circle' }
